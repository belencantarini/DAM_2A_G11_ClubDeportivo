...
class ClientesFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val listaClientesBusqueda = dbHelper.obtenerClientes()
        ...
        clientesListaReciclerView.adapter = ClientesAdapter(listaClientesBusqueda, configBotones, onVerClick = { cliente ->
